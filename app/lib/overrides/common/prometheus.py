...
def prometheus(callback_values):
    ...
    data = {
            ...
            'alertmanager.yml': {
                ...
                'route': {
                    ...
                    'routes': [{
                        ...
                        'match_re': {
                            'persistentvolume': '.*(davidwang).*'
                        },
                        'receiver': 'email-team-dev'
                    }, {
                        'match_re': {
                            'persistentvolumeclaim': '.*(davidwang).*'
                        },
                        'receiver': 'email-team-dev'
                    }, {
                        'match_re': {
                        ...
                        'match_re': {
                            'persistentvolume': core_pods
                        },
                        'receiver': 'email-team-core'
                    }, {
                        'match_re': {
                            'persistentvolumeclaim': core_pods
                        },
                        'receiver': 'email-team-core'
                    }, {
                        'match_re': {
        ...
        'pushgateway': {
            ...
            'ingress': {
                ...
                'enabled': False,
                'tls': [{
                    'hosts': ['pushgateway.__REPLACE_CLUSTER_FQDN__'],
                    'secretName': 'wildcard-production-tls'
                }]
            },
            'priorityClassName': 'common-critical',
                ...
                'groups': [
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ElasticSearch node: {{ $labels.instance }} last scrape of the ElasticSearch cluster health failed',
                                    'summary':
                                    'ElasticSearch node: {{ $labels.instance }} last scrape of the ElasticSearch cluster health failed'
                                },
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'Instance {{ $labels.instance }}: not all primary and replica shards are allocated in elasticsearch cluster {{ $labels.cluster }}.',
                                    'summary':
                                    'Instance {{ $labels.instance }}: not all primary and replica shards are allocated in elasticsearch cluster {{ $labels.cluster }}'
                                },
                            ...
                            },
                            {
                                ...
                                'expr':
                                'elasticsearch_jvm_memory_used_bytes{area="heap"} / elasticsearch_jvm_memory_max_bytes{area="heap"} > 0.8',
                                'for': '15m',
                                'labels': {
                                    'severity': 'critical'
                                }
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ElasticSearch node {{ $labels.instance }}: Count of JVM GC runs > 5 per sec and has a value of {{ $value }}',
                                    'summary':
                                    'ElasticSearch node {{ $labels.instance }}: Count of JVM GC runs > 5 per sec and has a value of {{ $value }}'
                                },
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ElasticSearch node {{ $labels.instance }}: GC run time in seconds > 0.3 sec and has a value of {{ $value }}',
                                    'summary':
                                    'ElasticSearch node {{ $labels.instance }}: GC run time in seconds > 0.3 sec and has a value of {{ $value }}'
                                },
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ElasticSearch node {{ $labels.instance }}: json parse failures > 25 and has a value of {{ $value }}',
                                    'summary':
                                    'ElasticSearch node {{ $labels.instance }}: json parse failures > 25 and has a value of {{ $value }}'
                                },
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ElasticSearch node {{ $labels.instance }}: breakers tripped > 0 and has a value of {{ $value }}',
                                    'summary':
                                    'ElasticSearch node {{ $labels.instance }}: breakers tripped > 0 and has a value of {{ $value }}'
                                },
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ElasticSearch node {{ $labels.instance }}: Number of cluster health checks timed out > 0 and has a value of {{ $value }}',
                                    'summary':
                                    'ElasticSearch node {{ $labels.instance }}: Number of cluster health checks timed out > 0 and has a value of {{ $value }}'
                                },
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'The Kubelet on {{ $labels.node }} has not checked in with the API, or has set itself to NotReady, for more than an hour',
                            ...
                            },
                            {
                                ...
                                'expr':
                                'count(kube_node_status_condition{condition="Ready",status="true"} == 0) > 1 and (count(kube_node_status_condition{condition="Ready",status="true"} == 0) / count(kube_node_status_condition{condition="Ready",status="true"})) > 0.2',
                                'for': '10m',
                                'labels': {
                                    'severity': 'critical'
                                }
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'Kubelet {{$labels.instance}} is running {{$value}} pods, close to the limit of 1100',
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} ({{ $labels.container }}) is restarting {{ printf "%.2f" $value }} / minute',
                            ...
                            },
                            {
                                ...
                                'expr':
                                'kube_deployment_spec_replicas != floor(avg_over_time(kube_deployment_status_replicas_available[5m]))',
                                'for': '15m',
                                'labels': {
                                    'severity': 'critical'
                                }
                            ...
                            },
                            {
                                ...
                                'expr':
                                'kube_statefulset_replicas != floor(avg_over_time(kube_statefulset_status_replicas_ready[5m]))',
                                'for': '15m',
                                'labels': {
                                    'severity': 'critical'
                                }
                    ...
                    },
                    {
                        ...
                        'rules': [
                            ...
                            },
                            {
                                ...
                                'expr':
                                'sum(namespace_name:kube_pod_container_resource_requests_memory_bytes:sum) / sum(node_memory_MemTotal) > (count(node:node_num_cpu:sum)-1) / count(node:node_num_cpu:sum)',
                                'for': '5m',
                                'labels': {
                                    'severity': 'warning'
                                }
                            },
                            {
                                ...
                                'expr':
                                'sum(kube_resourcequota{type="hard", resource="requests.cpu"}) / sum(node:node_num_cpu:sum) > 1.5',
                                'for': '5m',
                                'labels': {
                                    'severity': 'warning'
                                }
                            },
                            {
                                ...
                                'expr':
                                'sum(kube_resourcequota{type="hard", resource="requests.memory"}) / sum(node_memory_MemTotal) > 1.5',
                                'for': '5m',
                                'labels': {
                                    'severity': 'warning'
                                }
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{ printf "%0.0f" $value }}% usage of {{ $labels.resource }} in namespace {{ $labels.namespace }}.',
                                    'summary': 'K8s resource quota execeeded'
                                },
                                'expr':
                                '100 * kube_resourcequota{type="used"} / ignoring(instance, job, type) kube_resourcequota{type="hard"} > 90',
                                'for': '15m',
                                'labels': {
                                    'severity': 'warning'
                                }
                    ...
                    },
                    {
                        ...
                        'rules': [{
                            ...
                            'annotations': {
                                'description':
                                'The persistent volume claimed by {{ $labels.persistentvolumeclaim }} in namespace {{ $labels.namespace }} has {{ printf "%0.0f" $value }}% free.',
                    ...
                    },
                    {
                        ...
                        'rules': [
                            ...
                            },
                            {
                                ...
                                'expr':
                                'count(count(kubernetes_build_info{job!="kube-system/kube-dns",k8s_app!="kube-dns"}) by (gitVersion)) > 1',
                                'for': '1h',
                                'labels': {
                                    'severity': 'warning'
                                }
                        ...
                        'rules': [  # yapf: disable
                            {
                                ...
                                'annotations': {
                                    'message':
                                    '{{ $value }}% of instances in job restarted more than 3 times in past hour.',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    ...
                                    '{{ $value }}% of instances in job restarted more than 3 times in past hour.',
                                    'summary':
                                    'More than 10% of instances in job restarted more than 3 times in past hour.'
                                },
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'ScrapeTargetDown for job={{ $labels.job }} resource_name={{ $labels.kubernetes_name }}',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{ $labels.job }}: {{ $labels.namespace }}/{{ $labels.pod }} ({{ $labels.instance }}) is using {{ $value }}% of the available file/socket descriptors.',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{ $labels.job }}: {{ $labels.namespace }}/{{ $labels.pod }} ({{ $labels.instance }}) instance will exhaust in file/socket descriptors soon',
                    ...
                    },
                    {
                        ...
                        'rules': [{
                            ...
                            'annotations': {
                                'description':
                                'CronJob {{$labels.namespaces}}/{{$labels.cronjob}} is taking more than 1h to complete',
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'Prometheus failed to scrape API server(s), or all API servers have disappeared from service discovery.',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '99th percentile Latency for {{ $labels.verb }} requests to the kube-apiserver is higher than 1s.',
                                    'summary': 'Kubernetes apiserver latency is high'
                                },
                                'expr':
                                'histogram_quantile(0.99, sum(rate(apiserver_request_latencies_bucket{subresource!="log",verb!~"^(?:CONNECT|WATCHLIST|WATCH|PROXY)$"}[10m])) by (le)) / 1e+06 > 1',
                                'for': '10m',
                                'labels': {
                                    'severity': 'warning'
                                }
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'Observed deployment generation does not match expected one for deployment {{$labels.namespaces}}/{{$labels.deployment}}',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'Replicas are not updated and available for deployment {{$labels.namespaces}}/{{$labels.deployment}}',
                                    'summary': 'Deployment replicas are outdated'
                                },
                                'expr':
                                '(kube_deployment_status_replicas_updated != kube_deployment_spec_replicas) unless (kube_deployment_spec_paused == 1)',
                                'for': '15m',
                                'labels': {
                                    'severity': 'warning'
                                }
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'Only {{$value}}% of desired pods scheduled and ready for daemon set {{$labels.namespaces}}/{{$labels.daemonset}}',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    'A number of daemonsets are running where they are not supposed to run.',
                                    'summary': 'Daemonsets are not scheduled correctly'
                                },
                    ...
                    },
                    {
                        ...
                        'rules': [
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{$labels.instance}}: CPU usage is above 90% (current value is: {{ $value }})',
                                    'summary': '{{$labels.instance}}: High CPU usage detected'
                                },
                                'expr':
                                '(100 - (avg by (instance) (irate(node_cpu{job="kubernetes-nodes",mode="idle"}[5m])) * 100)) > 90',
                                'for': '30m',
                                'labels': {
                                    'severity': 'warning'
                                }
                            },
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{$labels.instance}}: Memory usage is above 90% (current value is: {{ $value }})',
                                    'summary': '{{$labels.instance}}: High memory usage detected'
                                },
                                'expr':
                                '(((node_memory_MemTotal-node_memory_MemFree-node_memory_Cached)/(node_memory_MemTotal)*100)) > 90',
                                'for': '30m',
                                'labels': {
                                    'severity': 'warning'
                                }
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'message':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} zk_avg_latency was greater than 50.',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'message':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} zk_avg_latency was greater than 100.',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'message':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} zk_outstanding_requests was greater than 10 for greater than 5m.',
                                    'summary':
                                    'Zookeeper enqueued too many requests. Zookeeper was unable to keep up with requests it received.'
                                },
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'message':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} zk_pending_syncs was greater than 10 for greater than 5m.',
                            ...
                            },
                            {
                                ...
                                'annotations': {
                                    'message':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} followers was not equal to (number of ensemble servers -1) for 20m.',
                                    'summary':
                                    "Zookeeper followers was less than expected per the StatefulSet's desired replica count."
                                },
                                'expr':
                                'avg(zk_followers) != ( avg(kube_statefulset_replicas{statefulset="zookeeper"}) - 1 )',
                                'for': '20m',
                                'labels': {
                                    'severity': 'critical'
                                }
                        ...
                        'rules': [
                            {
                                ...
                                'annotations': {
                                    'description':
                                    '{{ $labels.namespace }}/{{ $labels.pod }} was terminated with reason=OOMKilled.',
                ...
                'groups': [
                    ...
                    },
                    {
                        ...
                        'rules': [
                            ...
                            {
                                'expr':
                                'count by (node) (sum by (node, cpu) (node_cpu * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:))',
                            ...
                            {
                                'expr':
                                '1 - avg by (node) (rate(node_cpu{mode="idle"}[1m]) * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:)',
                            ...
                            {
                                'expr':
                                'sum by (node) (node_load1 * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:) / node:node_num_cpu:sum',
                                'record': 'node:node_cpu_saturation_load1:'
                            },
                            {
                                'expr':
                                '1 - sum(node_memory_MemFree + node_memory_Cached + node_memory_Buffers) / sum(node_memory_MemTotal)',
                                'record': ':node_memory_utilisation:'
                            },
                            {
                                'expr':
                                'sum by (node) ((node_memory_MemFree + node_memory_Cached + node_memory_Buffers) * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:)',
                            ...
                            {
                                'expr':
                                '(node:node_memory_bytes_total:sum - node:node_memory_bytes_available:sum) / scalar(sum(node:node_memory_bytes_total:sum))',
                            ...
                            {
                                'expr':
                                '1e3 * sum by (node) ((rate(node_vmstat_pgpgin[1m]) + rate(node_vmstat_pgpgout[1m])) * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:)',
                            ...
                            {
                                'expr':
                                'avg by (node) (irate(node_disk_io_time_ms{device=~"(sd|xvd).+"}[1m]) / 1e3 * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:)',
                            ...
                            {
                                'expr':
                                'sum(irate(node_network_receive_bytes{device="eth0"}[1m])) + sum(irate(node_network_transmit_bytes{device="eth0"}[1m]))',
                            ...
                            {
                                'expr':
                                'sum(irate(node_network_receive_drop{device="eth0"}[1m])) + sum(irate(node_network_transmit_drop{device="eth0"}[1m]))',
