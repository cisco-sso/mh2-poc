{   '__meta': {'chart': 'stable/dex', 'version': '0.5.0'},
    'config': {   'connectors': [   {   'config': {   'clientID': '__REPLACE__',
                  ...
                  'staticClients': [   {   'id': 'alertmanager.__REPLACE_CLUSTER_FQDN__',
                                           'name': 'alertmanager',
    ...
    'ingress': {   'annotations': {   'external-dns.alpha.kubernetes.io/target': 'dyndns.davidwang.com',
                   ...
                   'path': '/',
                   'tls': [   {   'hosts': ['dex.__REPLACE_CLUSTER_FQDN__'],
                                  'secretName': 'wildcard-production-tls'}]},
    'ports': [   {'containerPort': 8080, 'name': 'http', 'protocol': 'TCP'},
                 {'containerPort': 5000, 'name': 'grpc', 'protocol': 'TCP'}],
    'rbac': {'create': True},
    'replicas': 1,
