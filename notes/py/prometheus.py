                    ...
                    'routes': [
                        {
                            'match_re': {
                                'alertname':
                                '^(K8S.+|Kube.+Overcommit|KubeQuota.+|KubePersist.+|KubeNode.+|KubeVersion.+|KubeClient.+|Elasticsearch.+|Node.+Usage)$'
                            },
                        ...
                        },
                        {
                            'match_re': {
                                'cronjob':
                                '.*(cert-manager|chaoskube|cluster-autoscaler|consul|dashboard|docker-registry|elasticsearch|external-dns|filebeat|fluentd-elasticsearch|grafana|kafka|kibana|logstash|minio|nginx-ingress|oauth2-proxy|prometheus|stolon|vault|zookeeper).*'
                            },
                            'receiver': 'email-team-core'
                        },
                        {
                ...
                'groups': [
                    {
                        ...
                        'rules': [
                            ...
                            {
                                'alert':
                                'ElasticsearchInstanceJvmHeapTooHigh',
                                'annotations': {
                                    'description':
                                    'The '
                                    'heap '
                            ...
                            'labels': {
                                'severity': 'warning'
                                  ...
                                  },
                                  {
                                      ...
                                      'expr':
                                      'sum(kube_resourcequota{type="hard", '
                    ...
                    },
                    {
                        ...
                        'rules': [
                            ...
                            },
                            {
                                ...
                                'expr':
                                'count(count(kubernetes_build_info{job!="kube-system/kube-dns",k8s_app!="kube-dns"}) '
                                'by '
                                '(gitVersion)) '
                                '> '
                                '1',
                        ...
                        'rules': [{
                            ...
                            'labels': {
                                'severity': 'warning'
                                  ...
                                  {
                                      'alert':
                                      'ZookeeperWrongNumberOfFollowersPerStatefulSet',
                                      'annotations': {
                                          'message':
                                          '{{ '
                                          '$labels.namespace '
                    ...
                    },
                    {
                        ...
                        'rules': [
                            ...
                            },
                            {
                                ...
                                'expr':
                                'kube_endpoint_address_available{namespace!="kube-system",endpoint!="cluster-autoscaler"} '
                                '+ '
                                       ...
                                       'relabel_configs': [{
                                           ...
                                           ['__meta_kubernetes_ingress_annotation_prometheus_io_probe']
                                       },
                                                           {
                                                               ...
                                                               '${1}://${2}${3}',
                                                               'source_labels': [
                                                                   '__meta_kubernetes_ingress_scheme', '__address__',
                    ...
                    'rules': [{
                        ...
                        'record': 'namespace:container_cpu_usage_seconds_total:sum_rate'
                              ...
                              },
                              {
                                  ...
                                  '"(.*)"))\n',
                                  'record':
                                  'namespace_name:kube_pod_container_resource_requests_memory_bytes:sum'
                              },
                              {
                                  'expr':
                                  'sum '
                ...
                },
                           {
                               ...
                               'rules': [{
                                   ...
                                   'record': ':kube_pod_info_node_count:'
                                         ...
                                         {
                                             'expr':
                                             'avg(irate(node_disk_io_time_weighted{device=~"(sd|xvd).+"}[1m]) '
                                             '/ '
                                             '1e3)',
                                             'record':
