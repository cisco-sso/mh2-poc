{   '__meta': {'chart': 'cisco-sso/gangway', 'version': '0.1.0'},
    'affinity': {   'podAntiAffinity': {   'preferredDuringSchedulingIgnoredDuringExecution': [   {   'podAffinityTerm': {   'labelSelector': {   'matchLabels': {   'release': 'gangway'}},
                                                                                                                             'topologyKey': 'failure-domain.beta.kubernetes.io/zone'},
                                                                                                      'weight': 50}],
                                           'requiredDuringSchedulingIgnoredDuringExecution': [   {   'labelSelector': {   'matchLabels': {   'release': 'gangway'}},
                                                                                                     'topologyKey': 'kubernetes.io/hostname',
                                                                                                     'weight': 40}]}},
    'configFiles': {   'gangway.yaml': '\n'
    ...
    'ingress': {   'annotations': {   'external-dns.alpha.kubernetes.io/target': 'dyndns.davidwang.com',
                                      'kubernetes.io/ingress.class': 'nginx',
                                      'nginx.ingress.kubernetes.io/force-ssl-redirect': 'true'},
                   'enabled': True,
                   'hosts': ['gangway.__REPLACE_CLUSTER_FQDN__'],
                   'path': '/',
                   'tls': [   {   'hosts': ['gangway.__REPLACE_CLUSTER_FQDN__'],
